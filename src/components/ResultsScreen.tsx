...
import { Trophy, Target, TrendingUp, Clock, RotateCcw, Home } from 'lucide-react';
...
export default function ResultsScreen({ results, onStartNew, onBackToTopics }: ResultsScreenProps) {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-6">
            <div className={`p-4 ${performance.color} rounded-full`}>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-8 border border-white/20 text-center">
          <div className={`text-6xl font-bold mb-4 ${getScoreColor(averageScore)}`}>
            {averageScore.toFixed(1)}/10
          </div>
          <div className={`inline-flex items-center px-4 py-2 rounded-full text-white text-lg font-semibold ${performance.color}`}>
            {performance.level}
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center">
          <button
            onClick={onStartNew}
            className="flex items-center justify-center space-x-2 px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white rounded-lg font-semibold transition-all duration-200 transform hover:scale-105"
          >
          ...
          <button
            ...
            className="flex items-center justify-center space-x-2 px-8 py-3 bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/20 hover:border-white/30 text-white rounded-lg font-semibold transition-all duration-200"
          >
        ...
        <div className="flex justify-end mb-6">
          <button
            ...
            className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors shadow"
          >
